...
def debug_pytorch_overhead():
    ...
    print(f"📊 Total time: {np.mean(total_times)*1000:.2f} ± {np.std(total_times)*1000:.2f} ms")
    print(f"📊 Conversion time: {np.mean(conversion_times)*1000:.2f} ± {np.std(conversion_times)*1000:.2f} ms")
    print(f"📊 MFA time: {np.mean(mfa_times)*1000:.2f} ± {np.std(mfa_times)*1000:.2f} ms")
    print(f"📊 Conversion overhead: {np.mean(conversion_times)/np.mean(total_times)*100:.1f}%")
