...
for (name, seqLen, headDim) in testConfigs {
  ...
  print(
    "  FP16: \(String(format: "%.1f", fp16Memory)) KB (\(String(format: "%.1fx", fp32Memory / fp16Memory)) reduction)"
  )
  print(
    "  INT8: \(String(format: "%.1f", int8Memory)) KB (\(String(format: "%.1fx", fp32Memory / int8Memory)) reduction)"
  )
  print(
    "  INT4: \(String(format: "%.1f", int4Memory)) KB (\(String(format: "%.1fx", fp32Memory / int4Memory)) reduction)"
  )
  ...
  print(
    "  INT8: \(String(format: "%.3f", int8Time)) ms (\(String(format: "%.1fx", fp16Time / int8Time)) speedup)"
  )
  print(
    "  INT4: \(String(format: "%.3f", int4Time)) ms (\(String(format: "%.1fx", fp16Time / int4Time)) speedup)"
  )
}
